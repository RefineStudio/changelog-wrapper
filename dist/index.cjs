...
var require_use_sync_external_store_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-with-selector.development.js"(exports2) {
    ...
    "production" !== process.env.NODE_ENV && function() {
      ...
      var React = require("react"), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = React.useSyncExternalStore, useRef = React.useRef, useEffect2 = React.useEffect, useMemo = React.useMemo, useDebugValue = React.useDebugValue;
      exports2.useSyncExternalStoreWithSelector = function(subscribe, getSnapshot, getServerSnapshot, selector, isEqual) {
        var instRef = useRef(null);
        if (null === instRef.current) {
          var inst = { hasValue: false, value: null };
...
// node_modules/@headlessui/react/dist/hooks/use-disposables.js
function p() {
  let [e5] = (0, import_react.useState)(o3);
...
var n = (e5, t10) => {
  s.isServer ? (0, import_react2.useEffect)(e5, t10) : (0, import_react2.useLayoutEffect)(e5, t10);
};

// node_modules/@headlessui/react/dist/hooks/use-latest-value.js
function s3(e5) {
  let r13 = (0, import_react3.useRef)(e5);
  return n(() => {
    r13.current = e5;
  }, [e5]), r13;
}
...
var o5 = function(t10) {
  let e5 = s3(t10);
  return import_react4.default.useCallback((...r13) => e5.current(...r13), [e5]);
};
...
function L() {
  let n12 = U();
  return (0, import_react6.useCallback)((r13) => C(__spreadValues({ mergeRefs: n12 }, r13)), [n12]);
}
...
function F(n12, r13 = {}, e5, a17, s11) {
  ...
  if (t10 === import_react6.Fragment && (Object.keys(m(o12)).length > 0 || Object.keys(m(u11)).length > 0)) if (!(0, import_react6.isValidElement)(f11) || Array.isArray(f11) && f11.length > 1) {
...
`));
    ...
    return (0, import_react6.cloneElement)(f11, Object.assign({}, g3, u11, y7, { ref: s11(H(f11), y7.ref) }, T7));
  }
  return (0, import_react6.createElement)(t10, Object.assign({}, h(o12, ["ref"]), t10 !== import_react6.Fragment && y7, t10 !== import_react6.Fragment && u11), f11);
}
function U() {
  let n12 = (0, import_react6.useRef)([]), r13 = (0, import_react6.useCallback)((e5) => {
...
function K(n12) {
  var r13;
  return Object.assign((0, import_react6.forwardRef)(n12), { displayName: (r13 = n12.displayName) != null ? r13 : n12.name });
}
function m(n12) {
...
function H(n12) {
  return import_react6.default.version.split(".")[0] >= "19" ? n12.props.ref : n12.ref;
}
...
function y(...t10) {
  let n12 = (0, import_react8.useRef)(t10);
...
function f3() {
  let r13 = (0, import_react9.useContext)(a4);
  if (r13 === null) {
...
function w2() {
  let [r13, e5] = (0, import_react9.useState)([]);
  return [r13.length > 0 ? r13.join(" ") : void 0, (0, import_react9.useMemo)(() => function(t10) {
    let i11 = o5((n12) => (e5((s11) => [...s11, n12]), () => e5((s11) => {
      let o12 = s11.slice(), p6 = o12.indexOf(n12);
      return p6 !== -1 && o12.splice(p6, 1), o12;
    }))), l9 = (0, import_react9.useMemo)(() => ({ register: i11, slot: t10.slot, name: t10.name, props: t10.props, value: t10.value }), [i11, t10.slot, t10.name, t10.props, t10.value]);
    return import_react9.default.createElement(a4.Provider, { value: l9 }, t10.children);
  }, [e5])];
}
var S2 = "p";
function C2(r13, e5) {
  let d7 = (0, import_react7.useId)(), t10 = a2(), _a = r13, { id: i11 = `headlessui-description-${d7}` } = _a, l9 = __objRest(_a, ["id"]), n12 = f3(), s11 = y(e5);
  n(() => n12.register(i11), [i11, n12.register]);
  let o12 = t10 || false, p6 = (0, import_react9.useMemo)(() => __spreadProps(__spreadValues({}, n12.slot), { disabled: o12 }), [n12.slot, o12]), D3 = __spreadProps(__spreadValues({ ref: s11 }, n12.props), { id: i11 });
...
function C3({ value: t10, children: o12 }) {
  return import_react10.default.createElement(e2.Provider, { value: t10 }, o12);
}
...
// node_modules/@headlessui/react/dist/hooks/use-is-top-layer.js
function I(o12, s11) {
  let t10 = (0, import_react11.useId)(), r13 = x2.get(s11), [i11, c12] = S3(r13, (0, import_react11.useCallback)((e5) => [r13.selectors.isTop(e5, t10), r13.selectors.inStack(e5, t10)], [r13, t10]));
  return n(() => {
...
function k3(o12, f11, h7) {
  let m6 = s3(h7), s11 = (0, import_react15.useCallback)(function(e5, c12) {
  ...
  }, [m6, f11]), i11 = (0, import_react15.useRef)(null);
  ...
  let l9 = (0, import_react15.useRef)({ x: 0, y: 0 });
...
function n8(...e5) {
  return (0, import_react16.useMemo)(() => o2(...e5), [...e5]);
}
...
function o10(t10) {
  return (0, import_react18.useSyncExternalStore)(t10.subscribe, t10.getSnapshot, t10.getSnapshot);
}
...
function c5(u11 = 0) {
  let [t10, l9] = (0, import_react19.useState)(u11), g3 = (0, import_react19.useCallback)((e5) => l9(e5), [t10]), s11 = (0, import_react19.useCallback)((e5) => l9((a17) => a17 | e5), [t10]), m6 = (0, import_react19.useCallback)((e5) => (t10 & e5) === e5, [t10]), n12 = (0, import_react19.useCallback)((e5) => l9((a17) => a17 & ~e5), [l9]), F4 = (0, import_react19.useCallback)((e5) => l9((a17) => a17 ^ e5), [l9]);
...
function x3(t10, n12, e5, i11) {
  let [r13, o12] = (0, import_react20.useState)(e5), { hasFlag: s11, addFlag: a17, removeFlag: l9 } = c5(t10 && r13 ? 3 : 0), u11 = (0, import_react20.useRef)(false), f11 = (0, import_react20.useRef)(false), E7 = p();
  return n(() => {
    var d7;
    if (t10) {
      if (e5 && o12(true), !n12) {
...
function m5(u11, t10) {
  let e5 = (0, import_react21.useRef)([]), r13 = o5(u11);
...
var n9 = (0, import_react22.createContext)(null);
...
function u8() {
  return (0, import_react22.useContext)(n9);
}
function c7({ value: o12, children: t10 }) {
  return import_react22.default.createElement(n9.Provider, { value: o12 }, t10);
}
function s8({ children: o12 }) {
  return import_react22.default.createElement(n9.Provider, { value: null }, o12);
}
...
function c8(t10) {
  let r13 = o5(t10), e5 = (0, import_react23.useRef)(false);
...
var t8 = __toESM(require("react"), 1);
function s9() {
...
function l7(o12) {
  return import_react24.default.createElement(e4.Provider, { value: o12.force }, o12.children);
}

// node_modules/@headlessui/react/dist/components/portal/portal.js
function I3(e5) {
  let l9 = a13(), o12 = (0, import_react25.useContext)(H4), [r13, u11] = (0, import_react25.useState)(() => {
    var i11;
  ...
  }, [r13, e5]), (0, import_react25.useEffect)(() => {
    l9 || o12 !== null && u11(o12.current);
  }, [o12, u11, l9]), r13;
}
var M2 = import_react25.Fragment;
var D = K(function(l9, o12) {
  let _a = l9, { ownerDocument: r13 = null } = _a, u11 = __objRest(_a, ["ownerDocument"]), t10 = (0, import_react25.useRef)(null), a17 = y(T((s11) => {
    t10.current = s11;
  }), o12), i11 = n8(t10), f11 = r13 != null ? r13 : i11, p6 = I3(f11), [n12] = (0, import_react25.useState)(() => {
    var s11;
    return s.isServer ? null : (s11 = f11 == null ? void 0 : f11.createElement("div")) != null ? s11 : null;
  }), P5 = (0, import_react25.useContext)(g2), O5 = l6();
  n(() => {
  ...
  let b7 = L();
  return O5 ? !p6 || !n12 ? null : (0, import_react_dom.createPortal)(b7({ ourProps: { ref: a17 }, theirProps: u11, slot: {}, defaultTag: M2, name: "Portal" }), n12) : null;
});
function J(e5, l9) {
  let o12 = y(l9), _a = e5, { enabled: r13 = true, ownerDocument: u11 } = _a, t10 = __objRest(_a, ["enabled", "ownerDocument"]), a17 = L();
  return r13 ? import_react25.default.createElement(D, __spreadProps(__spreadValues({}, t10), { ownerDocument: u11, ref: o12 })) : a17({ ourProps: { ref: o12 }, theirProps: t10, slot: {}, defaultTag: M2, name: "Portal" });
}
var X = import_react25.Fragment;
var H4 = (0, import_react25.createContext)(null);
function k4(e5, l9) {
  let _a = e5, { target: o12 } = _a, r13 = __objRest(_a, ["target"]), t10 = { ref: y(l9) }, a17 = L();
  return import_react25.default.createElement(H4.Provider, { value: o12 }, a17({ ourProps: t10, theirProps: r13, defaultTag: X, name: "Popover.Group" }));
}
var g2 = (0, import_react25.createContext)(null);
function oe() {
  let e5 = (0, import_react25.useContext)(g2), l9 = (0, import_react25.useRef)([]), o12 = o5((t10) => (l9.current.push(t10), e5 && e5.register(t10), () => r13(t10))), r13 = o5((t10) => {
    let a17 = l9.current.indexOf(t10);
    a17 !== -1 && l9.current.splice(a17, 1), e5 && e5.unregister(t10);
  }), u11 = (0, import_react25.useMemo)(() => ({ register: o12, unregister: r13, portals: l9 }), [o12, r13, l9]);
  return [l9, (0, import_react25.useMemo)(() => function({ children: a17 }) {
    return import_react25.default.createElement(g2.Provider, { value: u11 }, a17);
  }, [u11])];
}
var B = K(J);
var q = K(k4);
...
function f9() {
  var t10;
  let [e5] = (0, import_react26.useState)(() => typeof window != "undefined" && typeof window.matchMedia == "function" ? window.matchMedia("(pointer: coarse)") : null), [o12, c12] = (0, import_react26.useState)((t10 = e5 == null ? void 0 : e5.matches) != null ? t10 : false);
  return n(() => {
    if (!e5) return;
    function n12(r13) {
      c12(r13.matches);
...
var a15 = (0, import_react27.createContext)(null);
function P4({ children: r13, node: n12 }) {
  let [o12, l9] = (0, import_react27.useState)(null), u11 = y6(n12 != null ? n12 : o12);
  return import_react27.default.createElement(a15.Provider, { value: u11 }, r13, u11 === null && import_react27.default.createElement(f2, { features: s4.Hidden, ref: (t10) => {
    var i11, c12;
    if (t10) {
...
function y6(r13 = null) {
  var n12;
  return (n12 = (0, import_react27.useContext)(a15)) != null ? n12 : r13;
}
...
function D2(s11, e5) {
  let t10 = (0, import_react30.useRef)(null), r13 = y(t10, e5), _a = s11, { initialFocus: o12, initialFocusFallback: a17, containers: n12, features: u11 = 15 } = _a, f11 = __objRest(_a, ["initialFocus", "initialFocusFallback", "containers", "features"]);
  l6() || (u11 = 0);
  let l9 = n8(t10);
  ...
  }), A5 = I(!!(u11 & 2), "focus-trap#tab-lock"), N = p(), b7 = (0, import_react30.useRef)(false), k5 = { ref: r13, onKeyDown(c12) {
  ...
  return import_react30.default.createElement(import_react30.default.Fragment, null, A5 && import_react30.default.createElement(f2, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: v2, features: s4.Focusable }), B2({ ourProps: k5, theirProps: f11, defaultTag: $2, name: "FocusTrap" }), A5 && import_react30.default.createElement(f2, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: v2, features: s4.Focusable }));
}
var w5 = K(D2);
var Re = Object.assign(w5, { features: G2 });
function ee(s11 = true) {
  let e5 = (0, import_react30.useRef)(n10.slice());
  return m5(([t10], [r13]) => {
...
function re(s11, { ownerDocument: e5, container: t10, initialFocus: r13, initialFocusFallback: o12 }) {
  let a17 = (0, import_react30.useRef)(null), n12 = I(!!(s11 & 1), "focus-trap#initial-focus"), u11 = f10();
  return m5(() => {
    if (s11 === 0) return;
    if (!n12) {
...
function ue(e5) {
  var t10;
  return !!(e5.enter || e5.enterFrom || e5.enterTo || e5.leave || e5.leaveFrom || e5.leaveTo) || ((t10 = e5.as) != null ? t10 : de) !== import_react31.Fragment || import_react31.default.Children.count(e5.children) === 1;
}
var w6 = (0, import_react31.createContext)(null);
w6.displayName = "TransitionContext";
var _e = ((n12) => (n12.Visible = "visible", n12.Hidden = "hidden", n12))(_e || {});
function De() {
  let e5 = (0, import_react31.useContext)(w6);
  if (e5 === null) throw new Error("A <Transition.Child /> is used but it is missing a parent <Transition /> or <Transition.Root />.");
  return e5;
}
function He() {
  let e5 = (0, import_react31.useContext)(M4);
  if (e5 === null) throw new Error("A <Transition.Child /> is used but it is missing a parent <Transition /> or <Transition.Root />.");
  return e5;
}
var M4 = (0, import_react31.createContext)(null);
...
function Te(e5, t10) {
  let n12 = s3(e5), l9 = (0, import_react31.useRef)([]), S6 = f10(), R2 = p(), d7 = o5((o12, i11 = A.Hidden) => {
  ...
  }), C6 = (0, import_react31.useRef)([]), p6 = (0, import_react31.useRef)(Promise.resolve()), h7 = (0, import_react31.useRef)({ enter: [], leave: [] }), g3 = o5((o12, i11, a17) => {
  ...
  return (0, import_react31.useMemo)(() => ({ children: l9, register: y7, unregister: d7, onStart: g3, onStop: v2, wait: p6, chains: h7 }), [y7, d7, l9, g3, v2, h7, p6]);
}
var de = import_react31.Fragment;
var fe = O.RenderStrategy;
function Ae(e5, t10) {
  var ee2, te2;
  let _a = e5, { transition: n12 = true, beforeEnter: l9, afterEnter: S6, beforeLeave: R2, afterLeave: d7, enter: y7, enterFrom: C6, enterTo: p6, entered: h7, leave: g3, leaveFrom: v2, leaveTo: o12 } = _a, i11 = __objRest(_a, ["transition", "beforeEnter", "afterEnter", "beforeLeave", "afterLeave", "enter", "enterFrom", "enterTo", "entered", "leave", "leaveFrom", "leaveTo"]), [a17, s11] = (0, import_react31.useState)(null), r13 = (0, import_react31.useRef)(null), f11 = ue(e5), j5 = y(...f11 ? [r13, t10, s11] : t10 === null ? [] : [t10]), H6 = (ee2 = i11.unmount) == null || ee2 ? A.Unmount : A.Hidden, { show: u11, appear: z2, initial: K2 } = De(), [m6, G3] = (0, import_react31.useState)(u11 ? "visible" : "hidden"), Q = He(), { register: A5, unregister: I5 } = Q;
  n(() => A5(r13), [A5, r13]), n(() => {
  ...
  let ce = K2 && !z2, Y = z2 && u11 && K2, W = (0, import_react31.useRef)(false), L4 = Te(() => {
  ...
  let he = L();
  return import_react31.default.createElement(M4.Provider, { value: L4 }, import_react31.default.createElement(c7, { value: N }, he({ ourProps: Ce, theirProps: i11, defaultTag: de, features: fe, visible: m6 === "visible", name: "Transition.Child" })));
}
function Ie(e5, t10) {
  let _a = e5, { show: n12, appear: l9 = false, unmount: S6 = true } = _a, R2 = __objRest(_a, ["show", "appear", "unmount"]), d7 = (0, import_react31.useRef)(null), y7 = ue(e5), C6 = y(...y7 ? [d7, t10] : t10 === null ? [] : [t10]);
  l6();
  let p6 = u8();
  ...
  let [h7, g3] = (0, import_react31.useState)(n12 ? "visible" : "hidden"), v2 = Te(() => {
    n12 || g3("hidden");
  }), [o12, i11] = (0, import_react31.useState)(true), a17 = (0, import_react31.useRef)([n12]);
  n(() => {
    o12 !== false && a17.current[a17.current.length - 1] !== n12 && (a17.current.push(n12), i11(false));
  }, [a17, n12]);
  let s11 = (0, import_react31.useMemo)(() => ({ show: n12, appear: l9, initial: o12 }), [n12, l9, o12]);
  n(() => {
  ...
  return import_react31.default.createElement(M4.Provider, { value: v2 }, import_react31.default.createElement(w6.Provider, { value: s11 }, H6({ ourProps: __spreadProps(__spreadValues({}, r13), { as: import_react31.Fragment, children: import_react31.default.createElement(me, __spreadProps(__spreadValues(__spreadValues({ ref: C6 }, r13), R2), { beforeEnter: f11, beforeLeave: j5 })) }), theirProps: {}, defaultTag: import_react31.Fragment, features: fe, visible: h7 === "visible", name: "Transition" })));
}
function Le(e5, t10) {
  let n12 = (0, import_react31.useContext)(w6) !== null, l9 = u8() !== null;
  return import_react31.default.createElement(import_react31.default.Fragment, null, !n12 && l9 ? import_react31.default.createElement(X2, __spreadValues({ ref: t10 }, e5)) : import_react31.default.createElement(me, __spreadValues({ ref: t10 }, e5)));
}
var X2 = K(Ie);
var me = K(Ae);
var Fe = K(Le);
...
function O4(e5) {
  let t10 = (0, import_react32.useContext)(w7);
  if (t10 === null) {
...
var z = K(function(t10, o12) {
  let a17 = (0, import_react7.useId)(), _a = t10, { id: n12 = `headlessui-dialog-${a17}`, open: i11, onClose: s11, initialFocus: d7, role: p6 = "dialog", autoFocus: T7 = true, __demoMode: u11 = false, unmount: y7 = false } = _a, S6 = __objRest(_a, ["id", "open", "onClose", "initialFocus", "role", "autoFocus", "__demoMode", "unmount"]), F4 = (0, import_react32.useRef)(false);
  p6 = function() {
  ...
  let f11 = (0, import_react32.useRef)(null), I5 = y(f11, o12), b7 = n8(f11), g3 = i11 ? 0 : 1, [v2, Q] = (0, import_react32.useReducer)(Ue, { titleId: null, descriptionId: null, panelRef: (0, import_react32.createRef)() }), m6 = o5(() => s11(false)), B2 = o5((r13) => Q({ type: 0, id: r13 })), D3 = l6() ? g3 === 0 : false, [Z, ee2] = oe(), te2 = { get current() {
    var r13;
  ...
  let H6 = S3(P5, (0, import_react32.useCallback)((r13) => P5.selectors.isTop(r13, n12), [P5, n12]));
  k3(H6, M5, (r13) => {
  ...
  let [oe2, ne4] = w2(), re2 = (0, import_react32.useMemo)(() => [{ dialogState: g3, close: m6, setTitleId: B2, unmount: y7 }, v2], [g3, v2, m6, B2, y7]), N = (0, import_react32.useMemo)(() => ({ open: g3 === 0 }), [g3]), le = { ref: I5, id: n12, role: p6, tabIndex: -1, "aria-modal": u11 ? void 0 : g3 === 0 ? true : void 0, "aria-labelledby": v2.titleId, "aria-describedby": oe2, unmount: y7 }, ae = !f9(), E7 = G2.None;
  D3 && !u11 && (E7 |= G2.RestoreFocus, E7 |= G2.TabLock, T7 && (E7 |= G2.AutoFocus), ae && (E7 |= G2.InitialFocus));
  let ie2 = L();
  return import_react32.default.createElement(s8, null, import_react32.default.createElement(l7, { force: true }, import_react32.default.createElement(ne, null, import_react32.default.createElement(w7.Provider, { value: re2 }, import_react32.default.createElement(q, { target: f11 }, import_react32.default.createElement(l7, { force: false }, import_react32.default.createElement(ne4, { slot: N }, import_react32.default.createElement(ee2, null, import_react32.default.createElement(Re, { initialFocus: d7, initialFocusFallback: f11, containers: M5, features: E7 }, import_react32.default.createElement(C3, { value: m6 }, ie2({ ourProps: le, theirProps: S6, slot: N, defaultTag: He2, features: Ne, visible: g3 === 0, name: "Dialog" })))))))))));
});
var He2 = "div";
...
function We(e5, t10) {
  ...
  return (a17 !== void 0 || o12) && !n12.static ? import_react32.default.createElement(P4, null, import_react32.default.createElement(ze, { show: a17, transition: o12, unmount: n12.unmount }, import_react32.default.createElement(z, __spreadValues({ ref: t10 }, n12)))) : import_react32.default.createElement(P4, null, import_react32.default.createElement(z, __spreadValues({ ref: t10, open: a17 }, n12)));
}
var $e = "div";
function je(e5, t10) {
  let o12 = (0, import_react7.useId)(), _a = e5, { id: a17 = `headlessui-dialog-panel-${o12}`, transition: n12 = false } = _a, i11 = __objRest(_a, ["id", "transition"]), [{ dialogState: s11, unmount: d7 }, p6] = O4("Dialog.Panel"), T7 = y(t10, p6.panelRef), u11 = (0, import_react32.useMemo)(() => ({ open: s11 === 0 }), [s11]), y7 = o5((I5) => {
    I5.stopPropagation();
  }), S6 = { ref: T7, id: a17, onClick: y7 }, F4 = n12 ? Fe : import_react32.Fragment, c12 = n12 ? { unmount: d7 } : {}, f11 = L();
  return import_react32.default.createElement(F4, __spreadValues({}, c12), f11({ ourProps: S6, theirProps: i11, slot: u11, defaultTag: $e, name: "Dialog.Panel" }));
}
var Ye = "div";
function Je(e5, t10) {
  let _a = e5, { transition: o12 = false } = _a, a17 = __objRest(_a, ["transition"]), [{ dialogState: n12, unmount: i11 }] = O4("Dialog.Backdrop"), s11 = (0, import_react32.useMemo)(() => ({ open: n12 === 0 }), [n12]), d7 = { ref: t10, "aria-hidden": true }, p6 = o12 ? Fe : import_react32.Fragment, T7 = o12 ? { unmount: i11 } : {}, u11 = L();
  return import_react32.default.createElement(p6, __spreadValues({}, T7), u11({ ourProps: d7, theirProps: a17, slot: s11, defaultTag: Ye, name: "Dialog.Backdrop" }));
}
var Ke = "h2";
function Xe(e5, t10) {
  let o12 = (0, import_react7.useId)(), _a = e5, { id: a17 = `headlessui-dialog-title-${o12}` } = _a, n12 = __objRest(_a, ["id"]), [{ dialogState: i11, setTitleId: s11 }] = O4("Dialog.Title"), d7 = y(t10);
  (0, import_react32.useEffect)(() => (s11(a17), () => s11(null)), [a17, s11]);
  let p6 = (0, import_react32.useMemo)(() => ({ open: i11 === 0 }), [i11]), T7 = { ref: d7, id: a17 };
...
var ChangelogContent = ({ entries }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-8", children: [
  entries.map((entry, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "article",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex flex-col sm:flex-row sm:items-start sm:space-x-4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "flex-shrink-0 sm:w-32", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("time", { className: "text-sm font-medium text-gray-500 dark:text-gray-400", children: formatDate(entry.date) }) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex-1 min-w-0 mt-2 sm:mt-0", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { className: "text-xl font-semibold text-gray-900 dark:text-white mb-3", children: entry.title }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "prose prose-sm dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 leading-relaxed", children: entry.content }),
          entry.tags && entry.tags.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "flex flex-wrap gap-2 mt-4", children: entry.tags.map((tag) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "span",
            {
  ...
  entries.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "text-center py-12", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-gray-500 dark:text-gray-400", children: "No changelog entries found." }) })
] });
function Changelog({
  entries,
  theme = "light",
  ...
  const [internalOpen, setInternalOpen] = (0, import_react34.useState)(true);
  ...
  const Wrapper = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: clsx_default(theme === "dark" && "dark", className), children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "bg-white dark:bg-zinc-900 text-black dark:text-white min-h-0", children }) });
  if (display === "modal") {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Wrapper, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Lt, { open, onClose: handleClose, className: "relative z-50", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fixed inset-0 flex items-center justify-center p-4", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Lt.Panel, { className: "bg-white dark:bg-zinc-900 rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Lt.Title, { className: "text-lg font-semibold text-gray-900 dark:text-white", children: "Changelog" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "button",
            {
              onClick: handleClose,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "flex-1 overflow-y-auto p-6", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChangelogContent, { entries }) })
      ] }) })
    ] }) });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Wrapper, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "max-w-4xl mx-auto p-6", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-6", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "sticky top-0 bg-white dark:bg-zinc-900 pb-4 border-b border-gray-200 dark:border-gray-700 mb-6", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { className: "text-2xl font-bold text-gray-900 dark:text-white", children: "Changelog" }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChangelogContent, { entries })
  ] }) }) });
}
